...
Enunciado
Hacer una calculadora. Para ello el programa iniciará
y contará con un menú de opciones:
    ...
    do
    {
    	 ...
    	 switch(opcion)
    	 {
    	       ...
    	       else
    	       {
    	    	   ...
    	    	   printf("2-Error: luego del ingreso de los numeros haga las operaciones.\n");
    	    	   printf("3-Error: luego del ingreso de los numeros haga las operaciones.\n");
    	    	   printf("4-Error: luego del ingreso de los numeros haga las operaciones.\n");
    	       ...
    	       printf("5-Gracias por usar mi programa!!\n");
